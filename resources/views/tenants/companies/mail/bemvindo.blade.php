...
<table border="0" cellpadding="0" cellspacing="0" style="margin: 0; padding: 0" width="100%">
    ...
    " class="100p">
                                            <tr>
                                                ...
                                                <td align="center" width="50%" class="100p"><img
                                                        src="{{ url('assets/images/logo-the-place.png') }}" width="200
    " height="96"/>
                                                </td>
                                            </tr>
                                        </table>
    ...
    text-decoration: none;" href="http://{{ $company->subdomain ?? 'teste'}}{{env('APP_SUBDOMAIN') }}">http://{{ $company->subdomain ?? 'teste' }}{{ env('APP_SUBDOMAIN') }}</a>
                                                        ...
                                                        <br/>
                                                        <span style="font-size:24px;">Usuário: <br/>
                                                                {{ $company->email }}</span>
                                                        <br/><br/>

                                                        <span style="font-size:24px;">Senha: <br/>
                                                                {{ $senha  }}</span>
                                                        <br/><br/>
    ...
    " cellpadding="10" style="border:2px solid #FFFFFF;">
                                                        <tr>
                                                            <td align="center
    " style="color:#FFFFFF; font-size:16px;"><font face="'Roboto', Arial, sans-serif"><a href="http://{{ $company->subdomain ?? 'teste'}}{{env('APP_SUBDOMAIN') }}" style="color:#FFFFFF; text-decoration:none;">ACESSE AGORA</a></font></td>
                                                        </tr>
                                                    </table>
            ...
            <table width="640" border="0" cellspacing="0" cellpadding="20" bgcolor="#2a8e9d" class="100p">
                <tr>
                    <td align="center" style="font-size:24px; color:#FFFFFF;"><font face="'Roboto', Arial, sans-serif"><a href="http:\\www.theplace.com.br">www.theplace.com.br</a></font></td>
                </tr>
            </table>
            ...
            <table width="640" border="0" cellspacing="0" cellpadding="20" bgcolor="#ffffff" class="100p">
                <tr>
                    ...
                    <td align="right" width="50%" style="font-size:14px; color:#848484;">
                        <div align="center
    "><img src="http://tassets.mailee.me/mailee/testehtmltemplate2/instagram.jpg" width="30" height="30
    "/><img src="http://tassets.mailee.me/mailee/testehtmltemplate2/twitter.jpg" width="30" height="30
    "/><img src="http://tassets.mailee.me/mailee/testehtmltemplate2/facebook.jpg" width="30" height="30"/>
                        </div>
                    </td>
                </tr>
            </table>
