...
@section('title_postfix', ' - Detalhes do Modelo de Contrato')
...
@section('content_header')
    <div class="container-fluid">
        @include('tenants.includes.breadcrumbs',  ['title' => 'Gestão de Modelo de Contratos',
                               'breadcrumbs' => [
                               'Modelo de Contratos' => route('contracts.index'),
                               'Detalhes', ]
                              ])
    </div><!-- /.container-fluid -->
@stop
...
@section('content')
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            ...
            <p><strong>Nome: </strong>{{  $data->description }}</p>
        </div>
        <!-- /.card-body -->
    </div>

    @can('delete_stick')
        {!! Form::model($data, ['route' => ['contracts.destroy', $data->id], 'class' => 'form', 'method' => 'delete', 'id' => 'formDelete']) !!}
