...
@section('content_header')
    <div class="container-fluid">
        @include('tenants.includes.breadcrumbs',  ['title' => 'Gestão da Conta Financeira',
                               'breadcrumbs' => [
...
@section('content')
    ...
    @can('delete_financial_account')
        {!! Form::model($data, ['route' => ['financial-account.destroy', $data->id], 'class' => 'form', 'method' => 'delete', 'id' => 'formDelete']) !!}
