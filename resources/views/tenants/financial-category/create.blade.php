...
@section('title_postfix', ' - Cadastrar Nova Categoria Financeira')
...
@section('content')
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            @include('tenants.financial-category.partials.form')
        </div>
        <!-- /.card-body -->
    </div>
@stop
...
@section('js')
    ...
    <script type="text/javascript" src={{ asset('assets/js/financial-category/validation.js') }}></script>
@stop
