...
@section('title_postfix', ' - Cadastrar Estado')
...
@section('content_header')
    <div class="container-fluid">
        @include('tenants.includes.breadcrumbs',  ['title' => 'Gestão de Estados',
                               'breadcrumbs' => [
...
@section('content')
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            @include('tenants.states.partials.form')
        </div>
        <!-- /.card-body -->
    </div>
@stop
...
@section('js')
    ...
    <script type="text/javascript" src={{ asset('assets/js/states/validation.js') }}></script>
@stop
