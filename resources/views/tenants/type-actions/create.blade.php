...
@section('title_postfix', ' - Cadastrar Tipo de Ações')
...
@section('content')
    ...
    <div class="card card-outline card-info">
        ...
        <div class="card-body pad">
            @include('tenants.type-actions.partials.form')
        </div>
        <!-- /.card-body -->
    </div>
@stop
...
@section('js')
    ...
    <script type="text/javascript" src={{ asset('assets/js/type-actions/validation.js') }}></script>
@stop
