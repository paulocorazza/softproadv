                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                ...
                                <ul class="nav navbar-nav mx-auto">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="#service">Serviços</a>
                                    </li>
                                    <li class="nav-item"> <a class="nav-link" href="#pricing">Preços</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 ms-auto mt-5 mt-lg-0 mb-5 mb-lg-0">
                        <h1 class="mb-4 fw-normal wow fadeInUp" data-wow-duration="1.5s">Aumente seus resultados com <span class="fw-bold text-uppercase">SoftPro</span> Advogado!</h1>
                        <p class="lead mb-4 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">Sistema completo e fácil de usar</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="owl-carousel" data-items="1" data-autoplay="true">
                            <div class="item mx-3 my-3">
                                <div class="img-box box-shadow">
                                    ...
                                    <img class="img-fluid" src="assets/site/images/banner/03.jpg" alt="">
                                </div>
                            </div>
                            <div class="item mx-3 my-3">
                                <div class="img-box box-shadow">
                                    ...
                                    <img class="img-fluid" src="assets/site/images/banner/04.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <img class="img-fluid w-100" src="assets/site/images/svg/03.svg" alt="">
                    </div>
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8 col-md-12">
                        <div class="section-title">
                            ...
                            <h2 class="title">Invista seu tempo no que realmente importa, automatize seus processos gerenciais</h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="featured-item style-6">
                            ...
                            <div class="featured-desc">
                                <p>Organize os processos registrando o andamento, anexando arquivos importantes e acompanhando o progresso.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mt-5">
                        <div class="featured-item style-6">
                            ...
                            <div class="featured-desc">
                                <p>Conte com nosso atendimento, com avaliação positiva superior a 90%, via help desk e chat online em horário comercial.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-5">
                        ...
                        <div class="tab style-2">
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-tab1" data-bs-toggle="tab" href="#tab1-1" role="tab" aria-selected="true"> <i class="flaticon-data"></i>
                                        <h5>Marketing</h5>
                                    </a> <a class="nav-item nav-link" id="nav-tab2" data-bs-toggle="tab" href="#tab1-2" role="tab" aria-selected="false"><i class="flaticon-research"></i> <h5>Planning</h5></a>
                                    <a class="nav-item nav-link" id="nav-tab3" data-bs-toggle="tab" href="#tab1-3" role="tab" aria-selected="false"><i class="flaticon-analytics"></i> <h5>Anlysis</h5></a>
                                    <a class="nav-item nav-link" id="nav-tab4" data-bs-toggle="tab" href="#tab1-4" role="tab" aria-selected="false"><i class="flaticon-objective"></i> <h5>Stratergy</h5></a>
                                </div>
                            </nav>
                            <!-- Tab panes -->
                            <div class="tab-content" id="nav-tabContent">
                                <div role="tabpanel" class="tab-pane fade show active" id="tab1-1">
                                    <div class="row align-items-center">
                                        <div class="col-lg-6 col-md-12">
                                            <img class="img-fluid" src="assets/site/images/svg/04.svg" alt="">
                                        </div>
                                        <div class="col-lg-6 col-md-12 mt-5 mt-lg-0">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tab1-3">
                                    <div class="row align-items-center">
                                        <div class="col-lg-6 col-md-12">
                                            <img class="img-fluid" src="assets/site/images/svg/06.svg" alt="">
                                        </div>
                                        <div class="col-lg-6 col-md-12 mt-5 mt-lg-0">
                                            <h4 class="mb-4">Powerful & Awesome Marketing</h4>
                                            <p class="mb-4">Softino Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        ...
                        <div class="owl-carousel no-pb" data-dots="false" data-items="2" data-sm-items="1" data-autoplay="true">
                            <div class="item">
                                <div class="price-table style-3 mx-3 my-3">
                                    ...
                                    <a class="btn btn-theme btn-circle mt-4" href="#" data-text="Experimente 1 Mês grátis">
