...
class TenantSeederPermissionsMeet extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'tenants:permissions-meet {id?}';
     ...
     * @var string
     */
    protected $description = 'Run Seeder Progresses Published';
    ...
    private function execCommand(Company $company)
    {
        ...
        $run = Artisan::call('db:seed', [
                '--force' => true,
                '--class' => 'MeetPermissionsTableSeeder'
        ]);
